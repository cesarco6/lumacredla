<div class="form-area position-relative">
  <!-- div 1 -->
  <div id="view1" class="multisteps-form__panel js-active bg-gray" data-animation="slideHorz">
  ...
  <!-- div 2 -->
  <div id="view2" class="multisteps-form__panel bg-gray" data-animation="slideHorz">
    <div class="wizard-forms pb-0">
      <div class="inner clearfix">
        <div class="wizard-form-field mb-5">
  ...
  <!-- div 3 -->
  <div id="view3" class="multisteps-form__panel bg-gray" data-animation="slideHorz">
    <div class="wizard-forms pb-0">
      <div class="inner clearfix">
        <div class="wizard-form-field mb-5">
  ...
  <!-- div 4 -->
  <div id="view4" class="multisteps-form__panel cuatro" data-animation="slideHorz">
    <div class="wizard-forms pb-0">
      <div class="inner clearfix">
        ...
        <div class="wizard-form-field mb-85">
          <div class="row">
            <div class="col-md-12">
              <h4 class="color-red">Credencial 2</h4>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <h4 class="color-red">Credencial 1</h4>
            </div>
            <div class="col-12 col-md-6">
              <div class="wizard-form-input">
                <div class="w-100">
          ...
          <div class="row">
            <div class="col-md-12">
              <h4 class="color-red">Credencial 3</h4>
            </div>
            <div class="col-12 col-md-6">
              <div class="wizard-form-input">
                <div class="w-100">
  ...
  <!-- div 5 -->
  <div id="view5" class="multisteps-form__panel" data-animation="slideHorz">
    <div class="wizard-forms pb-0">
      <div class="inner clearfix">
