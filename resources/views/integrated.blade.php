...
<body>
    <div class="wrapper wizard d-flex clearfix multisteps-form h-100 position-relative" style="margin-top: 10px;">
        ...
        <div class="multisteps-form__form w-75 order-1 position-relative h-100" action="#" id="wizard">
            ...
            <div class="form-area position-relative">
                                    ...
                                    <div class="col-md-12 correo">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                ...
                                                <input type="email" name="email" class="form-control w-100" id="input-email" value="ackwebway@exert.net">
                                            </div>
                                        </div>
                                ...
                                <div class="row datos">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch d-flex align-items-center justify-content-end">
                                            ...
                                            <input class="form-check-input switch" type="checkbox" id="add_factura" value="factura">
                                        </div>
                                    </div>
                                </div>
                                <div class="row controlled-group-input" style="display:none" id="info-factura">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                ...
                                                <input type="text" id="txtRfc" class="form-control w-100 validate-RFC" id="input-rfc">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                ...
                                                <input type="text" id="txtNombreEmpresaFactura" name="text" class="form-control w-100 validate-name" id="input-nombre-empresa">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                ...
                                                <input type="text" id="txtDireccion" name="text" class="form-control w-100 validate-address" id="input-direccion">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                ...
                                                <input type="text" id="txtColonia" name="text" class="form-control w-100 validate-colonia" id="input-colonia">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                <label for="input-codigo-postal" class="form-label mb-2 text-left w-100 validate-postal-code">Código Postal</label>
                                                <input type="number" id="noCp" name="codigo" min="1" max="6" step="1" class="form-control w-100 validate-postal-code" id="input-codigo-postal">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                <label for="select-cfdi" class="form-label mb-2 text-left w-100 validate-CDFI">Uso de CFDI</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="wizard-form-input">
                                            <div class="w-100">
                                                ...
                                                <input type="number" id="noCredenciales" min="1" max="1000" step="1" class="form-control w-100" oninput="generateDynamicInputs()">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 logo">
                                        <div class="wizard-form-input wizard-document-upload mt-5">
                                            ...
                                            <div class="custom-file">
                                                <label for="file-upload" id="labelLogo" class="custom-file-label w-100 mt-0">.PNG, PDF o .SVG no mayor a 2mb.</label>
                ...
                <!-- div 4 -->
                <div class="multisteps-form__panel cuatro" data-animation="slideHorz">
                        <div class="wizard-forms pb-0">
                            <div class="inner clearfix">
                                <div class="wizard-form-field mb-85">
                                    <div class="row" id="dynamicInputsContainer">
                                        <!-- Las entradas dinámicas se agregarán aquí. -->
                                    </div>
                                </div>
                                <div class="col-md-12 mt-5 pt-5">
                                <div class="actions">
    ...
    <script src="{{asset('assets/js/formdinamico.js')}}"></script>
